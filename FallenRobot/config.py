class Config(object):
    ...
    EVENT_LOGS = (-1002094990285)  # Event logs channel to note down important bot level events
    ...
    TOKEN = "6732347837:AAEc4jF8XBeouIYW9iYjXtf0Cx7lGVHiHV8"  # Get bot token from @BotFather on Telegram
